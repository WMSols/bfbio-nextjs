export default function MissionVisionSection() {
  return (
    <section className="bg-[#FFE4FF] py-16 md:py-24">
      <div className="container max-w-4xl md:px-16">
        <h2 className="text-3xl font-medium text-black md:text-5xl">
          Our Mission
        </h2>
        <div className="mt-6 space-y-6 text-lg leading-relaxed text-black md:mt-8 md:text-[32px] md:leading-normal">
          <p>
        ...
        <p className="mt-6 text-lg leading-relaxed text-black md:mt-8 md:text-[32px] md:leading-normal">
