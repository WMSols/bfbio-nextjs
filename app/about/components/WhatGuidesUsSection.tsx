  ...
  return (
    <section className="bg-[#F7F7F7] py-16 md:py-24">
      <div className="container">
        <h2 className="text-center text-4xl text-black md:text-6xl lg:text-[64px]">
          What Guides Us
        </h2>

        <div className="mx-auto mt-12 grid max-w-5xl grid-cols-1 gap-12 md:mt-20 md:grid-cols-2 md:gap-20">
          <article>
