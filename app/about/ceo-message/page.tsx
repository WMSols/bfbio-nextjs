  ...
  return (
    <>
      <div className="mt-16 md:mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[380px_1fr] lg:grid-cols-[440px_1fr] gap-12 lg:gap-16">
            ...
            <div className="order-2">
              <div className="flex flex-col h-full pb-6 justify-center md:justify-between items-center text-center md:items-start md:text-left w-full">
                ...
                {/* Text Block & LinkedIn */}
                <div className="flex flex-col items-center md:items-start gap-4 md:gap-8 border-[#934397] border-t-2 pt-6 mb-8 md:mb-4 w-full">
                  ...
                  >
                    <span className="font-bold text-4xl bg-[#0077B5] text-white py-1 px-2 rounded">
                      in
                    </span>
                  </a>
                ...
                <a
                  href="#ceo-message"
                  className=" bg-brand-gradient text-white rounded-full hover:opacity-80 transition-opacity text-sm md:text-base gap-6 inline-flex items-center justify-center py-3.5 px-8  md:px-12 w-fit shadow-sm"
                >
        ...
        <div 
          id="ceo-message" 
          className="scroll-mt-28 max-w-4xl mx-1 sm:mx-auto px-8 text-black border-b-[2px] border-[#934397] pb-12 space-y-6 md:space-y-8 lg:space-y-10 mb-16 md:mb-24"
        >
