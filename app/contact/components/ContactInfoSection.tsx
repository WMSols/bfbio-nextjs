const ContactInfoSection = () => {
  return (
    <div className="w-full flex flex-col gap-6">
      ...
      <div className="bg-[#FFE4FF] rounded-[2rem] p-10 md:px-18 md:py-28 flex flex-col items-center text-center w-full">
      ...
      <div className="grid md:grid-cols-2 gap-6 h-full">
        ...
        {/* Registered Office */}
        <div className="bg-[#FFE4FF] rounded-[2rem] p-10 md:p-14 flex flex-col items-center text-center h-full">
