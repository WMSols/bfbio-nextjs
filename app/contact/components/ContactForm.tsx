    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid sm:grid-cols-2 gap-6">
        <div className="space-y-2.5">
          ...
          <Input
            ...
            className="bg-white rounded-sm border-gray-200 focus-visible:ring-[#3B73AC]"
          />
        </div>
        <div className="space-y-2.5">
      ...
      <div className="space-y-2.5">
        ...
        <Textarea
          ...
          value={form.message}
          onChange={handleChange}
          className="bg-white rounded-sm border-gray-200 focus-visible:ring-[#3B73AC] resize-y"
        />
      </div>
      ...
      <Button
        type="submit"
        variant="gradient"
        className="w-full rounded-full text-white py-6 mt-4"
        size="lg"
        disabled={submitting}
      >
