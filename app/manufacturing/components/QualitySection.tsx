    ...
    <section className="bg-white py-16 md:py-24">
      <div className="container">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-6 text-4xl leading-[1.15] font-medium text-brand-blue md:text-5xl lg:text-[56px]">
            {title}
          </h2>
          <p className="mt-6 text-lg leading-snug text-black md:text-[22px] md:leading-relaxed">
            {description}
          </p>
        </div>

        <div className="mx-auto mt-12 flex max-w-5xl flex-col gap-6 md:mt-16 md:gap-8">
          {cards.map((card, index) => (
            <GradientCard
              key={card.title}
              reverse={index % 2 === 1}
              innerClassName="px-8 py-10 md:px-14 md:py-12"
            >
