    ...
    <section className="py-16 md:py-24 mt-10 bg-background">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16 md:mb-20 max-w-5xl mx-auto">
          <h2 className="text-4xl text-black md:text-5xl mb-6">
            Build Your Future at <span className="text-[#934397]">Bf Biosciences</span>
          </h2>
          <p className="text-base  text-black font-light md:text-[22px] leading-relaxed">
            At Bf Bio Sciences, every role contributes to a larger purpose. Join a collaborative team that's<br className="hidden md:block"/>
            ...
            >
              ...
              <div className="relative w-full aspect-[4/3] rounded-[1.5rem] overflow-hidden mb-6 group">
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center transition-colors group-hover:bg-black/50">
                  <span className="text-white text-2xl md:text-3xl font-normal   tracking-wide drop-shadow-md">
                    {item.label}
                  </span>
                </div>
              </div>
              ...
              <div className="px-2 pb-4 flex-1 flex text-black flex-col">
                <h3 className="font-semibold text-lg font-sans mb-5 leading-snug">
                  {item.title}
                </h3>
