      ...
      <div className="flex flex-col items-start border border-black/30  justify-between gap-12 rounded-3xl bg-white py-16 px-8 md:py-24 md:px-20 sm:flex-row sm:items-center">
        <div className="flex flex-col w-full">
          <div className="flex  w-full md:flex-row  flex-col gap-4">
            <h3 className=" text-3xl flex-1 font-bold text-[#934397]">{title}</h3>
                <button
          onClick={() => setIsModalOpen(true)}
          className="whitespace-nowrap rounded-full bg-[#934397] h-12 px-8 hidden sm:inline-flex items-center justify-center text-base font-medium text-white transition-colors hover:bg-[#7a3280]"
        >
          Apply Now
        </button>
            </div>
            ...
            {skills?.split(",").map((skill, idx) => (
              ...
              >
                {skill}
                 ...
                 <button
          onClick={() => setIsModalOpen(true)}
          className="whitespace-nowrap rounded-full bg-[#934397] h-12 px-8 mt-4 sm:hidden inline-flex items-center justify-center text-base font-medium text-white transition-colors hover:bg-[#7a3280]"
        >
          Apply Now
        </button>
        </div>
