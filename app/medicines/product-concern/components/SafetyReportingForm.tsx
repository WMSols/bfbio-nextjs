        ...
        <div className="bg-black rounded-[2rem] py-2 px-1.5 flex w-full max-w-[500px] mb-16 md:mb-20 shadow-lg">
          <button
            ...
            className={`flex-1 py-8 px-6 rounded-[1.75rem] text-center text-xl transition-all duration-300 font-bold ${
              activeTab === "patient"
                ? "bg-[#934397] text-white shadow-md"
                  ...
                  <div className="flex flex-col gap-3">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-4 h-4 accent-[#934397]"
                      />
            ...
            <div className="flex flex-col gap-10">
                  ...
                  {[
                    ...
                    >
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-4 h-4 mt-1 accent-[#934397] shrink-0"
                      />
              ...
              <div className="mt-4">
                <button
                  ...
                  className="bg-[#934397] hover:bg-[#7a3280] text-white font-medium text-base h-12 px-8 rounded-full transition-colors shadow-sm hover:shadow-md disabled:opacity-70 disabled:cursor-not-allowed inline-flex items-center justify-center"
                >
