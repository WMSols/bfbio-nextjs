...
function DummySocialIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
const socialIcons = {
  instagram: DummySocialIcon,
  facebook: DummySocialIcon,
...
domain/competence shall not be entertained by the SECP.</p>
          ...
          <div className="flex flex-col gap-3 justify-self-end text-left md:text-right w-full md:w-auto">
            <p className="text-sm opacity-70 leading-relaxed">
              ...
              , Company Secretary
              <br />
              Office No. 204, 2nd Floor, Block B, Al-Hidayah Business Park, Faisal Town, Lahore - 54000
              <br />
              Email:{" "}
              <a
                href="mailto:info@bfbiosciences.com"
                className="hover:text-white transition-opacity"
              >
                info@bfbiosciences.com
              </a>
            </p>
          </div>
        </div>
