...
export const esgCategories: { key: ESGCategory; label: string; image: string }[] = [
  {
    key: "arts_culture",
    label: "Arts & Culture",
...
export const esgInitiativesData: ESGInitiative[] = [
  // --- ARTS & CULTURE ---
  {
    id: "ac-1",
...
export interface esgSlideshowImage {
  id: number;
  url: string;
  width: number;
  height: number;
...
// ESG Impact Card Data
export const ESGImpactCardData = [
  {
    id: 1,
...
// ESG Investors cards data
export const ESGInvestorsCardsData = [
  {
    id: 1,
